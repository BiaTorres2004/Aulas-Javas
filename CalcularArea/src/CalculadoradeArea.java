/*Para que serve o scanner? O scanner serve para separar a entrada dos texto em blocos*/
...
public class CalculadoradeArea {
	public static void main(String[] args) {
		...
		System.out.println("A Ŕrea do Quadrado é " + area);
		}
		
		else if(nome == 2 ) {
		double area = sistema.CalArea(7.5, 10.15);
		System.out.println("A Ŕrea do Triăngulo é " + area);
			}
		
		else {
		int area = sistema.CalArea(15, 10);
		System.out.println("A Ŕrea do Retângulo é " + area);
		}
